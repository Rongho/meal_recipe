        ...
        <>
       {
        ...
        <div className="content">
            ...
            <div className="inner-content">
                <h1>{item.strMeal}</h1>
                <h2>Origin of food:{item.strArea}</h2>
        ...
        <div className="recipe-details">
            <div className="ingredients">
                ...
                <h4>{item.strIngredient4}:{item.strMeasure3}</h4>
            ...
            <div className="instructions">
                <h2>Instuctions</h2><br/>
                <h4>{item.strInstructions}</h4>
            </div>
            <div className="video" >
                <iframe title="recipeVideo" src={`https://www.youtube.com/embed/${id}`}>
                </iframe>
            </div>
        </div>
        </>
